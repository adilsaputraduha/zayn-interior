                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="hidden" id="idpelanggan" name="idpelanggan" class="idpelanggan" value="<?= $row['pemesanan_pelanggan']; ?>">
                                <input type="text" id="namapelanggan" name="namapelanggan" required readonly class="form-control namapelanggan" value="<?= $row['pelanggan_nama']; ?>" />
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" value="<?= $row['pemesanan_tanggal']; ?>" class="form-control tanggalpemesanan <?= ($validation->hasError('tanggalpemesanan')) ? 'is-invalid' : ''; ?>" id="tanggalpemesanan" name="tanggalpemesanan" value="<?= old('tanggalpemesanan'); ?>" required placeholder="Masukan tanggalpemesanan">
                            <div class="invalid-feedback">
...
<script>
    ...
    function simpanTransaksi() {
        ...
        if (idpelanggan.length == 0) {
            ...
            $.ajax({
                url: "<?= base_url('admin/pemesanan/edit'); ?>",
                type: "POST",
                data: {
                    fakturpemesanan: fakturpemesanan,
