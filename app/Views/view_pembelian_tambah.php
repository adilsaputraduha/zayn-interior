            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control tanggalpembelian <?= ($validation->hasError('tanggalpembelian')) ? 'is-invalid' : ''; ?>" id="tanggalpembelian" name="tanggalpembelian" value="<?= old('tanggalpembelian'); ?>" required placeholder="Masukan tanggalpembelian">
                        <div class="invalid-feedback">
...
<script>
    ...
    function ajaxDelete(id, quantity, jumlah) {
        $.ajax({
            url: "<?= base_url('admin/bahanbaku/detail-delete'); ?>",
            type: "POST",
            data: {
                detailid: id,
            },
