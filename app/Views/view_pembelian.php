...
<div class="container">
    <div class="card">
        ...
        <div class="card-header">
            <a href="<?= base_url('admin/pembelian/tambah'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus mr-2"></i>Tambah</a>
            ...
            <table id="table" class="table table-bordered">
                ...
                <tbody>
                    ...
                    foreach ($pembelian as $row) : $no++ ?>
                        <tr>
                            <td> <?= $no; ?></td>
                            <td> <?= $row['pembelian_faktur']; ?></td>
                            <td> <?= $row['pembelian_tanggal']; ?></td>
                            <td> <?= $row['pembelian_total_item']; ?></td>
                            <td>Rp. <?= $row['pembelian_total_harga']; ?></td>
                            <td style="text-align: center;">
                                <a type="button" class="badge bg-info pointer" href="<?= base_url('admin/pembelian/update/' . $row['pembelian_faktur']); ?>">Edit</a>
                                <a type="button" class="badge bg-success" href="<?= base_url('admin/pembelian/faktur/' . $row['pembelian_faktur']); ?>" target="__blank">Faktur</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
